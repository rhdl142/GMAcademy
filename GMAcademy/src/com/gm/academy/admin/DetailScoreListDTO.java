...
public class DetailScoreListDTO {
	...
	private String grageSkillScore;
	...
	public String getGrageSkillScore() {
		return grageSkillScore;
	}
	public void setGrageSkillScore(String grageSkillScore) {
		this.grageSkillScore = grageSkillScore;
	}
